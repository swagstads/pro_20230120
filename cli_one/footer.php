    ...
    <div class="container">
        <div class="footerCopyRightInner clearfix">
            <div class="velaFooterSocial">
                <div class="velaContent">
                    <ul class="velaListSocial list-unstyled list-inline">
                        <li class="facebook">
                            <a target="_blank" href="https://www.facebook.com/" title="AtoZ on Facebook"
                                class="btn-social btn-social--facebook" data-original-title="Facebook">
                                <i class="fa fa-facebook"></i>
                                <span>Facebook</span>
                            </a>
                        </li>
                        <li class="twitter">
                            <a target="_blank" href="https://twitter.com/" title="AtoZ on Twitter"
                        ...
                        <li class="instagram">
                            <a target="_blank" href="index.php" title="AtoZ on Instagram"
                                class="btn-social btn-social--instagram" data-original-title="Instagram">
            ...
            <div class="velaCopyRight">
                Copyright © 2022 AtoZ all rights
                reserved.
            </div>
        </div>
    </div>
