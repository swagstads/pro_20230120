<style>
    .sticky-whatsapp-icon-container {
        position: fixed;
        bottom: 20px;
        right: 20px;
        height: 50px;
...
<a href="https://api.whatsapp.com/send/?phone=7700907449&text&type=phone_number&app_absent=0" target="_blank" class="sticky-whatsapp-icon-container">
    <div class="whatsapp-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" fill="white" class="bi bi-whatsapp" viewBox="0 0 16 16">
        ...
        <div class="footerCenterInner">
            <div class="rowFlex rowFlexMargin">
                    ...
                    <div class="vela-contactinfo velaBlock">
                        <div class="vela-content">
                            ...
                            <div class="contactinfo-address clearfix">
                                <i class="icons">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" style="
                ...
                <div class="col-xs-12 col-sm-7 col-md-7">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 mb20">
                        <div class="velaFooterMenu">
                            <h4 class="velaFooterTitle">Help Desk</h4>
                        ...
                        <div class="velaFooterMenu">
                            ...
                            <div class="velaContent">
                                <ul class="velaListSocial list-unstyled list-inline">
                                    <li class="facebook">
                                        <a target="_blank" href="https://www.facebook.com/" title="AtoZ on Facebook" class="btn-social btn-social--facebook" data-original-title="Facebook">
...
<div class="footerCopyRight">
    <div class="container">
        <div class="footerCopyRightInner clearfix" style="padding:20px">
            <div class="velaFooterSocial">
            Designed by <a href="https://swagstads.netlify.app/" style="color:#148ec8;">@GFX.Swagsta</a>
            </div>

            <div class="velaCopyRight">
                Copyright © 2023 all rights reserved by AtoZ Furnishings. 
            </div>
        </div>
    </div>
</div>