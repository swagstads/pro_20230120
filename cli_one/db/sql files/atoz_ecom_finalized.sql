...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2023 at 10:06 AM
...
CREATE TABLE `cart` (
  ...
  `status` enum('in cart','ordered') NOT NULL
...
(1, 'rugs and wallpaper', '1.jpg', 'active', '2023-03-10 11:52:59', '2023-03-10 11:52:59'),
...
CREATE TABLE `contact_us` (
  ...
  `status` enum('Pending','Read','Replied') NOT NULL,
...
CREATE TABLE `orders` (
  ...
  `product_id` varchar(128) NOT NULL,
  `quantity` varchar(128) NOT NULL,
  `status` enum('Approved','In Transit','Delivered','Cancelled') NOT NULL,
...
(2, 'Duet Sets', 'These are Duet Sets of cushion cover as well as bedsheets', 2000, '2100', '', '3', 0, 'active', '10', 'malav@atoz.com', '2023-03-11 10:20:19', '2023-03-11 10:20:19'),
...
(6, 'Bed Cover', 'Bed Covers', 1222, '133', '', '3', 0, 'active', '12', 'malav@atoz.com', '2023-03-11 10:43:14', '2023-03-11 10:43:14'),
(7, 'Bed Sheets', 'Beautiful Bed Sheets', 130, '152', '', '3', 0, 'active', '50', 'malav@atoz.com', '2023-03-11 10:44:30', '2023-03-11 10:44:30'),
(8, 'Throw', 'This throw are amazing', 100, '120', '', '3', 0, 'active', '10', 'malav@atoz.com', '2023-03-11 10:45:04', '2023-03-11 10:45:04'),
(9, 'Bolsters', 'This bolsters are amazing', 150, '1000', '', '3', 0, 'active', '10', 'malav@atoz.com', '2023-03-11 10:46:42', '2023-03-11 10:46:42'),
(10, 'Quilts', 'This quilts are amazing', 1400, '1500', '', '3', 0, 'active', '10', 'malav@atoz.com', '2023-03-11 10:47:28', '2023-03-11 10:47:28'),
...
(45, 'Rugs', 'This are rugs some different kind', 8000, '9000', '', '1', 0, 'active', '8', 'malav@atoz.com', '2023-03-11 14:26:16', '2023-03-11 14:26:16');
...
CREATE TABLE `tbl_admin` (
  ...
  `password` varchar(900) NOT NULL DEFAULT '25d55ad283aa400af464c76d713c07ad',
  `fullname` varchar(900) NOT NULL,
  `role` enum('Admin','Editor','Standard','Delete') NOT NULL DEFAULT 'Standard',
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `updated_at` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(0, 'malav@atoz.com', '25d55ad283aa400af464c76d713c07ad', 'Test Sub', 'Admin', '2023-03-10 11:34:53', '2023-03-10 11:37:25');
