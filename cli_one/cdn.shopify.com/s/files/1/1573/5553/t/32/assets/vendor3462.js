...
if (+ function(r) {
    ...
    v = function() {
        ...
        return t
    }, v.prototype.cleanUpEvents = function() {
        var t = this;
        t.options.dots && t.$dots !== null && (r("li", t.$dots).off("click.slick", t.changeSlide), t.options.pauseOnDotsHover === !0 && t.options.autoplay === !0 && r("li", t.$dots).off("mouseenter.slick", r.proxy(t.setPaused, t, !0)).off("mouseleave.slick", r.proxy(t.setPaused, t, !1))), t.options.arrows === !0 && t.slideCount > t.options.slidesToShow && (t.$prevArrow && t.$prevArrow.off("click.slick", t.changeSlide), t.$nextArrow && t.$nextArrow.off("click.slick", t.changeSlide)), t.$list.off("touchstart.slick mousedown.slick", t.swipeHandler), t.$list.off("touchmove.slick mousemove.slick", t.swipeHandler), t.$list.off("touchend.slick mouseup.slick", t.swipeHandler), t.$list.off("touchcancel.slick mouseleave.slick", t.swipeHandler), t.$list.off("click.slick", t.clickHandler), r(document).off(t.visibilityChange, t.visibility), t.$list.off("mouseenter.slick", r.proxy(t.setPaused, t, !0)), t.$list.off("mouseleave.slick", r.proxy(t.setPaused, t, !1)), t.options.accessibility === !0 && t.$list.off("keydown.slick", t.keyHandler), t.options.focusOnSelect === !0 && r(t.$slideTrack).children().off("click.slick", t.selectHandler), r(window).off("orientationchange.slick.slick-" + t.instanceUid, t.orientationChange), r(window).off("resize.slick.slick-" + t.instanceUid, t.resize), r("[draggable!=true]", t.$slideTrack).off("dragstart", t.preventDefault), r(window).off("load.slick.slick-" + t.instanceUid, t.setPosition), r(document).off("ready.slick.slick-" + t.instanceUid, t.setPosition)
        ...
        t.options.dots === !0 && t.slideCount > t.options.slidesToShow && r("li", t.$dots).on("click.slick", {
            message: "index"
        }, t.changeSlide), t.options.dots === !0 && t.options.pauseOnDotsHover === !0 && t.options.autoplay === !0 && r("li", t.$dots).on("mouseenter.slick", r.proxy(t.setPaused, t, !0)).on("mouseleave.slick", r.proxy(t.setPaused, t, !1))
...
//# sourceMappingURL=/s/files/1/1573/5553/t/32/assets/vendor.js.map?v=138786516400658099071601353808