<div class="breadcrum-strip-container">
    <div class="strip-content productpage-bredcrum">
        <div class="breadcrum-strip-left"><div class="hide-on-mobile" id="google_translate_element"></div></div>
        <div class="breadcrum-strip" >Call us @<a href="tel:9999999999">+91 99999 99999</a></div>
    </div>
</div>
<header id="header" class="velaHeader sticky-header">
    <section class="headerWrap">
        <div class="velaHeaderMain headerMenu">
            <div class="container">
                <div class="headerContent rowFlex justify-content-space-between flexAlignCenter rowFlexMargin">
                            ...
                            <div class="dropdown">
                                <button class="dropbtn">
                                    <h5>
                                        <b>
                                            <span>
                                                <svg width="20px" height="20px" viewBox=".5 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="menuMobileWrapper">
            ...
            <ul class="nav memoNav">
                ...
                <li class="hasMemoDropdown">
                    <a class="collapsed" title="" data-toggle="collapse" data-target="#memoDropdown221">Shop</a>
