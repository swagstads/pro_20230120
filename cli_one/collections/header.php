                                                ...
                                                <div class="rowFlex rowFlexMargin velaMenuListLink">
                                                    <div class="col-xs-12 col-sm-3">
                                                        <ul class="velaMenuLinks">
                                                            <li class="menuTitle">
                                                                <a href="cushion.php" title="">Cushion Covers</a>
                                                            </li>
                                                            <li>
                                                                <a href="cushion.php" title="">Leaves</a>
                                                            </li>
                                                            <li>
                                                                <a href="cushion.php" title="">Small
                                                                    motifs</a>
                                                            </li>
                                                            <li>
                                                                <a href="cushion.php" title="">Plain
                                                                    and textures</a>
                                                            </li>
                                                            <li>
                                                                <a href="cushion.php" title="">Stripes and
                                                                    checks</a>
                                                            </li>
                                                            <li>
                                                                <a href="cushion.php" title="">Abstract</a>
                                                            </li>
                                                            <li>
                                                                <a href="cushion.php" title="">Geometric</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                        <ul class="velaMenuLinks">
                                                            <li class="menuTitle">
                                                                <a href="rug.php" title="">Rugs</a>
                                                            </li>
                                                            <li>
                                                                <a href="rug.php" title="">Plain and
                                                                    Textures</a>
                                                            </li>
                                                            <li>
                                                                <a href="rug.php" title="">Classical</a>
                                                            </li>
                                                            <li>
                                                                <a href="rug.php" title="">Abstract</a>
                                                            </li>
                                                            <li>
                                                                <a href="rug.php" title="">Ethnic</a>
                                                            </li>
                                                            <li>
                                                                <a href="rug.php" title="">Stripes And
                                                                    Checks</a>
                                                            </li>
                                                            <li>
                                                                <a href="rug.php" title="">Damask</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                        <ul class="velaMenuLinks">
                                                            ...
                                                            <li>
                                                                <a href="linen.php" title="">Comforter</a>
                                                            </li>
                                                            <li>
                                                                <a href="linen.php" title="">Quilts</a>
                                                            </li>
                                                            <li>
                                                                <a href="linen.php" title="">Dohar</a>
                                                            </li>
                                                            <li>
                                                                <a href="linen.php" title="">Bedding Set</a>
                                                            </li>
                                                            <li>
                                                                <a href="linen.php" title="">Bed in
                                                                    Bag</a>
                                                            </li>
                                                            <li>
                                                                <a href="linen.php" title="">Hand
                                                                    towles</a>
                                                            </li>
                                                            <li>
                                                                <a href="linen.php" title="">Face
                                                                    towles</a>
                                                            </li>
                                                            <li>
                                                                <a href="linen.php" title="">Bath
                                                                    Robe</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                        <ul class="velaMenuLinks">
                                                            <li class="menuTitle">
                                                                <a href="curtain.php" title="">Ready Made
                                                                    Curtains</a>
                                                            </li>
                                                            <li>
                                                                <a href="curtain.php" title="">Botanical</a>
                                                            </li>
                                                            <li>
                                                                <a href="curtain.php" title="">Leaves</a>
                                                            </li>
                                                            <li>
                                                                <a href="curtain.php" title="">Shiny textures</a>
                                                            </li>
                                                            <li>
                                                                <a href="curtain.php" title="">Plain</a>
                                                            </li>
                                                            <li>
                                                                <a href="curtain.php" title="">Floral</a>
                                                            </li>
                                                            <li>
                                                                <a href="curtain.php" title="">Stripes and
                                                                    Checks</a>
                                                            </li>
                                                            <li>
                                                                <a href="curtain.php" title="">For
                                                                    Kids</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                ...
                                                <div class="velaMenuListCollection">
                                                    ...
                                                    <div class="velaMenuListContent rowFlex">
                                                        <div class="coll-item" style="width: 20%">
                                                            ...
                                                            <h5 class="collTitle">
                                                                <a href="rug.php" title="Decor Art">
                                                                    Rugs</a>
                                                            </h5>
                                                        </div>
                                                        ...
                                                        <div class="coll-item" style="width: 20%">
                                                            ...
                                                            <h5 class="collTitle">
                                                                <a href="curtain.php" title="Furniture">
                                                                    Curtain</a>
                                                            </h5>
                                                        </div>
                                                        ...
                                                        <div class="coll-item" style="width: 20%">
                                                            ...
                                                            <h5 class="collTitle">
                                                                <a href="cushion.php" title="Kitchen Things">
                                                                    Cushion</a>
                                                            </h5>
                                                        </div>
                                                        ...
                                                        <div class="coll-item" style="width: 20%">
                                                            ...
                                                            <h5 class="collTitle">
                                                                <a href="linen.php" title="Illumination">
                                                                    Bed & bath linen</a>
                                                            </h5>
                                                        </div>
                                                        ...
                                                        <div class="coll-item" style="width: 20%">
                                                            ...
                                                            <h5 class="collTitle">
                                                                <a href="blind.php" title="Sale Off">
                                                                    Blind</a>
                                                            </h5>
                                                        </div>
                                                    </div>
